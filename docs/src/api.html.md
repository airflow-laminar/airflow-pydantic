...
### airflow_pydantic.extras.common.airflow_functions.clean_dag_runs_api(delete_successful, delete_failed, mark_failed_as_successful, max_dagruns, days_to_keep, backend=None)[[source]](../../_modules/airflow_pydantic/extras/common/airflow_functions.html.md#clean_dag_runs_api)
...
### airflow_pydantic.extras.common.airflow_functions.clean_dags_api(backend=None)[[source]](../../_modules/airflow_pydantic/extras/common/airflow_functions.html.md#clean_dags_api)
...
#### *field* backend *: Literal['auto', 'airflow3', 'mwaa'] | None* *= 'auto'*

API backend used on Airflow 3

#### *field* connection_id *: str | None* *= 'airflow_laminar_api'*

Airflow connection with API credentials for the airflow3 backend

#### *field* mwaa_environment_name *: str | None* *= None*

MWAA environment name for the mwaa backend

#### *field* mwaa_region_name *: str | None* *= None*

AWS region of the MWAA environment
